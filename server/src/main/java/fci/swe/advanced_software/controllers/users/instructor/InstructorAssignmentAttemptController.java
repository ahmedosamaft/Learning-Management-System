...
public class InstructorAssignmentAttemptController {
    ...
    @PreAuthorize(""" 
            ...
            """)
    public ResponseEntity<?> getStudentAttempts(@PathVariable @ULID String courseId,
                                                @PathVariable @ULID String studentId,
    ...
    @PreAuthorize(""" 
            ...
            """)
    public ResponseEntity<?> getAssignmentAttempts(@PathVariable @ULID String courseId,
    ...
    @PreAuthorize(""" 
                       ...
                       AND @authorizationService.containsAttempt(#assignmentId,#attemptId)
            """)
    public ResponseEntity<?> updateAttempt(@PathVariable @ULID String courseId,
                                           @PathVariable @ULID String assignmentId,
                                           @PathVariable @ULID String attemptId,
